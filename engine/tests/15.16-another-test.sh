...
if grep -q "use RuntimeException;" app/Support/Router.php; then
    echo "Router RuntimeException import present."
else
    echo "ERROR: Router RuntimeException import is missing."
    exit 1
fi
...
echo
echo "========================================"
echo " JAROA 15.16 ANOTHER TEST PASSED"
echo "========================================"
echo
